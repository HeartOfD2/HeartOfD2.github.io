  ...
  normal: {
    1: {
      ...
      steps: [
        ...
        { text: "Countess (Optional)", location: "Cold Plains ◆ → Stony Field ◆ → Underground Passage → Dark Wood → Black Marsh ◆ → Forgotten Tower → Tower Cellar 1-5", tips: "Farm runes. Countess is on level 5", layout: "Follow left wall in Tower levels" },
    ...
    2: {
      ...
      steps: [
        ...
        { text: "Horadric Staff quest", location: "Lut Gholein → Rocky Waste → Dry Hills ◆ → Halls of the Dead 1-3 (◆ 2)", tips: "Horadric Cube is on level 3. Cube has unlimited uses" },
    ...
    3: {
      ...
      steps: [
        ...
        { text: "Khalim's Brain", location: "Spider Forest ◆ → Great Marsh ◆ → Flayer Jungle ◆ → Flayer Dungeon 1-3", tips: "Brain is on level 3. Great Marsh can sometimes be skipped depending on map layout" },
        { text: "Gidbinn (Optional)", location: "Flayer Jungle ◆", tips: "Optional quest. +1 all skills reward from Ormus" },
        { text: "Khalim's Heart", location: "Flayer Jungle ◆ → Lower Kurast ◆ → Kurast Bazaar ◆ → Sewers 1-2", tips: "Heart is in level 2 chest" },
        { text: "Lower Kurast waypoint", location: "Flayer Jungle ◆ → Lower Kurast ◆", tips: "Important waypoint for progression" },
    ...
    5: {
      ...
      steps: [
        ...
        { text: "Halls of Pain waypoint (Optional)", location: "Harrogath ◆ → Halls of Anguish → Halls of Pain ◆", tips: "Red portal from Anya in town. Optional waypoint before Nihlathak" },
        { text: "Kill Nihlathak (Optional)", location: "Halls of Pain ◆ → Halls of Vaught", tips: "Corpse Explosion danger - clear corpses carefully. Nihlathak is on level 3" },
  ...
  nightmare: {
    1: {
      ...
      steps: [
        ...
        { text: "Countess (Optional)", location: "Cold Plains ◆ → Stony Field ◆ → Underground Passage → Dark Wood → Black Marsh ◆ → Forgotten Tower → Tower Cellar 1-5", tips: "Better rune drops in Nightmare" },
    ...
    3: {
      ...
      steps: [
        ...
        { text: "Khalim's Brain", location: "Spider Forest ◆ → Great Marsh ◆ → Flayer Jungle ◆ → Flayer Dungeon 1-3", tips: "Brain on level 3. Great Marsh can sometimes be skipped" },
        { text: "Gidbinn (Optional)", location: "Flayer Jungle ◆", tips: "+1 all skills from Ormus" },
        { text: "Khalim's Heart", location: "Flayer Jungle ◆ → Lower Kurast ◆ → Kurast Bazaar ◆ → Sewers 1-2", tips: "Heart in level 2 chest" },
    ...
    5: {
      ...
      steps: [
        ...
        { text: "Halls of Pain waypoint (Optional)", location: "Harrogath ◆ → Halls of Anguish → Halls of Pain ◆", tips: "Red portal from Anya in town" },
        { text: "Kill Nihlathak (Optional)", location: "Halls of Pain ◆ → Halls of Vaught", tips: "Dangerous Corpse Explosion. Nihlathak is on level 3" },
  ...
  hell: {
    1: {
      ...
      steps: [
        ...
        { text: "Countess (Optional)", location: "Cold Plains ◆ → Stony Field ◆ → Underground Passage → Dark Wood → Black Marsh ◆ → Forgotten Tower → Tower Cellar 1-5", tips: "Best rune farming location. Up to Lo rune" },
        { text: "Get Scroll of Inifuss", location: "Cold Plains ◆ → Stony Field ◆ → Underground Passage → Dark Wood", tips: "Required for Cain" },
    ...
    3: {
      ...
      steps: [
        ...
        { text: "Khalim's Brain", location: "Spider Forest ◆ → Great Marsh ◆ → Flayer Jungle ◆ → Flayer Dungeon 1-3", tips: "Fetishes deal high damage. Great Marsh can sometimes be skipped" },
        { text: "Gidbinn (Optional)", location: "Flayer Jungle ◆", tips: "+1 all skills. Can skip if geared" },
        { text: "Khalim's Heart", location: "Flayer Jungle ◆ → Lower Kurast ◆ → Kurast Bazaar ◆ → Sewers 1-2", tips: "Undead Stygian Dolls explode for massive damage" },
    ...
    5: {
      ...
      steps: [
        ...
        { text: "Halls of Pain waypoint (Optional)", location: "Harrogath ◆ → Halls of Anguish → Halls of Pain ◆", tips: "Red portal from Anya in town" },
        { text: "Kill Nihlathak (Optional)", location: "Halls of Pain ◆ → Halls of Vaught", tips: "Corpse Explosion oneshots. Very dangerous. Nihlathak on level 3. Can drop Dol-Mal runes" },
